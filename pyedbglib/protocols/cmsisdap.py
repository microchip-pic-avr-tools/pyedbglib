...
class CmsisDapUnit(DapWrapper):
    ...
    DAP_ID_BOARD_VENDOR = 0x07
    DAP_ID_BOARD_NAME = 0x08
    DAP_ID_PRODUCT_FW_VER = 0x09
    ...
    def dap_info(self):
        ...
        info = {
            ...
            'board_vendor': self._dap_info_field(self.DAP_ID_BOARD_VENDOR),
            'board_name': self._dap_info_field(self.DAP_ID_BOARD_NAME),
            'product_fw_version': self._dap_info_field(self.DAP_ID_PRODUCT_FW_VER)
        }
        return info
...
class CmsisDapDebugger(CmsisDapUnit):
    ...
    def dap_swj_clock(self, clock):
        ...
        :raises PyedbglibError: if the configuration fails
        """
    ...
    def dap_reset_target(self):
        ...
        :raises PyedbglibError: if the reset fails
        """
    ...
    def dap_read_reg(self, reg):
        ...
        :raises PyedbglibError: if the read fails
        """
    ...
    def dap_write_reg(self, reg, value):
        ...
        :raises PyedbglibError: if the write fails
        """
    ...
    def read_block(self, address, numbytes):
        ...
        :raises PyedbglibError: if the transfer fails
        """
    ...
    def init_swj(self):
        ...
        :raises PyedbglibError: if the sequence execution fails
        """
