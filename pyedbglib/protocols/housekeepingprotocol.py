...
class Jtagice3HousekeepingProtocol(Jtagice3Protocol):
    ...
    HOUSEKEEPING_CONFIG_FPGA_FW_MAJ = 0x10 # FPGA firmware major version
    HOUSEKEEPING_CONFIG_FPGA_FW_MIN = 0x11 # FPGA firmware minor version
    HOUSEKEEPING_CONFIG_FPGA_FW_REV = 0x12 # FPGA firmware revision

    HOUSEKEEPING_CONFIG_AUX_MCU_FW_MAJ = 0x20 # Auxilliary MCU firmware major version
    HOUSEKEEPING_CONFIG_AUX_MCU_FW_MIN = 0x21 # Auxilliary MCU firmware minor version
    HOUSEKEEPING_CONFIG_AUX_MCU_FW_REV = 0x22 # Auxilliary MCU firmware revision
