...
class Gen4ControllerCommand(object):
    ...
    def set_script_source(self, src_id):
        ...
        :param src_id: source buffer ID for script
        """
...
class Gen4Controller(AsynchronousTransportInterface):
    ...
    def receive_script_execution_response(self):
        ...
        :return: array of 32-bits integers returned from the script execution
        """
        return self.read_response_buffer(ATI_RESPONSE_BUFFER_SIZE)

    def execute(self, script):
        """
        Atomic execution of a script

        :param script: array containing binary script byte-code to execute
        :return: results of script execution
        :raises Gen4Exception: if a script fails to execute
        """
